...
public class fileProject {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 파일 읽기
        ret = fileControl.createFile(newFilePath.toString());
        ...
        ret = fileControl.writeFile(newFilePath.toString(), inPut);
        // 파일 쓰기
        if (errorCode.ERROR_SUCCESS == ret) {
...
class fileControl {
    ...
    public int writeFile(String filePath, String data) {
        ...
        try {
            FileOutputStream fos = new FileOutputStream(writeFile); // createFile에서 생성한 객체와 같은건데...이렇게 써도 되는지 모르겠음ㅜ
